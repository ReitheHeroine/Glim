...
function NutrientBar({ nutrient, progress, onPlus }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 7 }}>
      <div style={{ width: 52, textAlign: 'right', fontFamily: "'Courier New', monospace", fontSize: 11, color: 'rgba(200,210,230,0.5)', flexShrink: 0 }}>
        {label}
      </div>
      ...
      <div style={{ width: 62, fontFamily: "'Courier New', monospace", fontSize: 11, color: countColor, fontWeight: countWeight, flexShrink: 0, whiteSpace: 'nowrap' }}>
        {countText}
      </div>

      <button
        onClick={() => onPlus(key)}
        style={{ width: 28, height: 28, borderRadius: '50%', border: '1px solid rgba(200,210,230,0.15)', background: 'rgba(200,210,230,0.06)', color: 'rgba(200,210,230,0.6)', fontFamily: "'Courier New', monospace", fontSize: 16, lineHeight: 1, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, padding: 0 }}
      >
        +
      </button>
    </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '4px 20px 6px', flexShrink: 0 }}>
        <span style={{ fontFamily: "'Courier New', monospace", fontSize: 13, color: 'rgba(200,210,230,0.75)', letterSpacing: '0.5px' }}>
          nutrition
        </span>
        <span style={{ fontFamily: "'Courier New', monospace", fontSize: 11, color: 'rgba(200,210,230,0.35)' }}>
          today
        </span>
      </div>
      ...
      {undoToast && (
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '4px 20px', flexShrink: 0 }}>
          <span style={{ fontFamily: "'Courier New', monospace", fontSize: 11, color: 'rgba(200,210,230,0.55)' }}>
            {undoToast.message}
          </span>
          <button
            onClick={handleUndo}
            style={{ fontFamily: "'Courier New', monospace", fontSize: 11, color: 'rgba(200,210,230,0.55)', background: 'none', border: '1px solid rgba(200,210,230,0.15)', borderRadius: 4, padding: '2px 8px', cursor: 'pointer' }}
          >
            undo
          </button>
        </div>
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '0 8px' }}>
          {visibleItems.length === 0 ? (
            <div style={{ fontFamily: "'Courier New', monospace", fontSize: 11, color: 'rgba(200,210,230,0.25)', textAlign: 'center', padding: '12px 0' }}>
      ...
      <div style={{ flexShrink: 0, borderTop: '1px solid rgba(200,210,230,0.06)' }}>
        ...
        >
          <span style={{ fontFamily: "'Courier New', monospace", fontSize: 11, color: 'rgba(200,210,230,0.55)', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        {streakExpanded && (
          <div style={{ padding: '0 20px 8px', display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            {perNutrientStreaks.map(({ label, color, days }) => (
              <span key={label} style={{ fontFamily: "'Courier New', monospace", fontSize: 10, color: 'rgba(200,210,230,0.5)', display: 'flex', alignItems: 'center', gap: 4 }}>
