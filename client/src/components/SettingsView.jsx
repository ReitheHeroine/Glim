...
// Purpose:     Settings content for focus mode. Renders the accordion sections
//              (single-expand), sign-out, and reset-all-data. No outer shell,
//              no header, no full-screen container - those live in FocusShell.
//              Each section is its own component that reads/writes its tracker
//              store directly.
// Inputs:      useSettingsStore, useWaterStore, useStepsStore, useNutritionStore
// Outputs:     A content block (accordion + action buttons), consumed by
//              FocusShell's content area.
// -----------------------------------------------------------------------------
