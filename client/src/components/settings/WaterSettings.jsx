      ...
      <div style={{ marginTop: 10 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <input
            ...
            style={inputBase}
          />
          <span style={{ fontSize: 'var(--glim-text-base)', color: 'rgba(200,210,230,0.5)' }}>oz</span>
        </div>
      </div>
      ...
      <div style={{ marginTop: 14 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <input
            ...
            style={inputBase}
          />
          <span style={{ fontSize: 'var(--glim-text-base)', color: 'rgba(200,210,230,0.5)' }}>bottles</span>
          <span style={{ fontSize: 'var(--glim-text-base)', color: 'rgba(200,210,230,0.35)' }}>
            ({totalOz} oz)
          </span>
        </div>
      </div>
